...
import { IDriver, IFile, IStore, Nullable } from "../../interfaces";

export const DriverCreate: React.FC<IResourceComponentsProps> = () => {
    const t = useTranslate();
    const stepTitles = [
        t("drivers.steps.content"),
        t("drivers.steps.relations"),
    ];
    ...
    } = useStepsForm<IDriver, HttpError, Nullable<IDriver>>({
        stepsProps: {
                        ...
                        >
                            <Grid item xs={12} md={4}>
                                ...
                                >
                                    ...
                                    >
                                        {t(
                                            "drivers.fields.images.description",
                                        )}
                                    </Typography>
                                    <Typography sx={{ fontSize: "12px" }}>
                                        {t("drivers.fields.images.validation")}
                                    </Typography>
                                </Stack>
                            </Grid>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={4} md={6}>
                                <FormControl fullWidth>
                                    ...
                                    >
                                        {t("drivers.fields.accountNumber")}
                                    </FormLabel>
                                    <TextField
